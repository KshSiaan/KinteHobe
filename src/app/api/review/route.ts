import { product, productVariant, review, activity } from "@/db/schema";
  ...
  try {
    ...
    try {
      await db.insert(activity).values({
        ...
        metaData: {
          productId: productData[0].product.id,
          productSlug: productData[0].product.slug,
          ratingFloat: parsedRating,
          reviewText: reviewText,
        },
        createdAt: new Date(),
      ...
      sentry.logger.error("Error inserting activity:", {
        ...(error as any),
      });
    }
