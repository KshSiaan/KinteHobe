...
export default function Page() {
  ...
  const { data, isPending } = useQuery({
    ...
    > => {
      const res = await fetch(`/api/product?preference=${preference}`);
  ...
  return (
    <main className="py-4">
      ...
      <section className="mx-auto container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
