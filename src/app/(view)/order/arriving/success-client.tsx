    ...
    <main className="p-4 md:p-8 max-w-2xl mx-auto">
      <div className="flex flex-col items-center text-center gap-4 mb-8">
        ...
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            Your package would soon be on its way to{" "}
          ...
          <p className="text-muted-foreground">
            You can view your order details and track its status in{" "}
            <Link
              href="/me/orders"
              className="underline text-primary hover:bg-primary hover:text-background transition-colors"
            >
              your account
            </Link>
            .
